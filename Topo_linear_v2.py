# %%
from Topo_function import threshold_W,create_Z,find_idx_set,create_new_topo,create_new_topo_greedy
import numpy as np
...
if __name__ == '__main__':
    ...
    start = timer()
    W_est,_,_,_ = model.fit(X = X,topo = topo_init, no_large_search=15,size_small=150, size_large=2500)
    end = timer()
